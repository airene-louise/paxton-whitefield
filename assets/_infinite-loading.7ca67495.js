...
const InfiniteLoading = {
   ...
   */ updateGrid: function(markup) {
        ...
        // Remove 'hide' class from all elements inside the current grid
        ...
        // Check if current grid has a promo banner
        ...
        // Add new products to current grid like this as 'innerHTML' removes event listeners and breaks quickshop
